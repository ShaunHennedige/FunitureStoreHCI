...
public class FormBedBunk extends javax.swing.JPanel {
    ...
    private void embedBunkBedPanel() {
        BunkBed bunkBedPanel = new BunkBed();
                ...
                layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                        .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                                        ...
                                        .addComponent(bunkBedPanel, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                                .addContainerGap())
        );
        layout.setVerticalGroup(
                layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                        .addGroup(layout.createSequentialGroup()
                                ...
                                .addComponent(bunkBedPanel, GroupLayout.DEFAULT_SIZE, 448, Short.MAX_VALUE)
                                .addContainerGap())
        );
    }
