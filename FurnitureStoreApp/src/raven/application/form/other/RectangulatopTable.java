...
public class RectangulatopTable extends JPanel implements GLEventListener {
    ...
    private final float[] tableColor = {0.54f, 0.27f, 0.07f}; // Default table color (brown)
    ...
    private void drawTable(GL2 gl) {
        ...
        gl.glScalef(1.5f, 0.05f, 1.0f); // Scale to make a rectangular cuboid top
        glut.glutSolidCube(1.0f); // Use glutSolidCube for a rectangular cuboid
        gl.glPopMatrix();
